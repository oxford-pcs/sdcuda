...
enum errors {
	...
	CPROCESS_REVERT_CROP_REGIONS_NOT_SET = -31,
	CPROCESS_REVERT_GROW_REGIONS_NOT_SET = -32,
	CPROCESS_REVERT_RESCALE_REGIONS_NOT_SET = -33,
...
const std::map<errors, char*> error_messages = {
	...
	{ CPROCESS_REVERT_CROP_REGIONS_NOT_SET, "CPROCESS_REVERT_CROP_REGIONS_NOT_SET" },
	{ CPROCESS_REVERT_GROW_REGIONS_NOT_SET, "CPROCESS_REVERT_GROW_REGIONS_NOT_SET" },
	{ CPROCESS_REVERT_RESCALE_REGIONS_NOT_SET, "CPROCESS_REVERT_RESCALE_REGIONS_NOT_SET" },
